...
| Public non-DICOM imaging or participant inventory | Use `references/artifact-model-v2.md`. Query public non-DICOM logical assets separately from their delivery/viewing locations. Keep managed-system provenance for troubleshooting, but present user-centered asset summaries. Query IDC rather than duplicating public DICOM detail. |
